...
@Component({
  selector: 'app-inventario-art-semanal-mat',
  templateUrl: './inventario-art-semanal-mat.component.html',
  styleUrls: ['./inventario-art-semanal-mat.component.scss'],
})
export class InventarioArtSemanalMatComponent implements OnInit {
 public today = new Date();
  ...
  async validarCantidad(stock, i) {
    ...
    this.service
      .serviceGeneralGet(`StockChicken/ValidateStockArtSemMat?id_sucursal=${this.user.branch}&dataBase=${this.user.dataBase}&cantidad=${stock.cantidad}&codarticulo=${stock.codarticulo}`)
      .subscribe((resp) => {
        respValidar = resp;
